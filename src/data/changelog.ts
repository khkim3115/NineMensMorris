...
export const CHANGELOG: ChangelogEntry[] = [
  {
    version: '0.2.1',
    date: '2026-09-08',
    title: '힌트가 헷갈리게 표시되던 문제를 고쳤어요',
    changes: [
      {
        type: 'fix',
        text: '🐛 힌트를 누른 뒤 표시가 뜨기 전에 곧바로 두면, 이전 상황을 기준으로 계산된 힌트가 새 판면 위에 잘못 표시되던 문제를 고쳤습니다. 이제 지나간 힌트는 표시되지 않아요.',
      },
      {
        type: 'improvement',
        text: '💡 말을 옮기는 힌트에서 어떤 말을 집어야 하는지 출발점에도 표시가 붙습니다. 그 말을 고르면 표시가 선택 표시로 바뀌어요.',
      },
    ],
  },
  {
